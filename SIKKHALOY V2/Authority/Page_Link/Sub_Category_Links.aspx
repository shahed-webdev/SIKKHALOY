<%@ Page Title="Sub-Category Link" Language="C#" MasterPageFile="~/Basic_Authority.Master" AutoEventWireup="true" CodeBehind="Sub_Category_Links.aspx.cs" Inherits="EDUCATION.COM.Authority.Page_Link.Sub_Category_Links" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <a href="Sub_Category.aspx?Category=<% =Request.QueryString["Category"] %>">Back to Sub-Category</a>
