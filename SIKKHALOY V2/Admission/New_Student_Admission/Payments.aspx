<%@ Page Title="Pay Order to Student" Language="C#" MasterPageFile="~/BASIC.Master" AutoEventWireup="true" CodeBehind="Payments.aspx.cs" Inherits="EDUCATION.COM.Admission.New_Student_Admission.Payments" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="CSS/New_Students_Payments.css" rel="stylesheet" />
    <style type="text/css">
        #Studnt_Payments .table-responsive { margin: 25px 0; }
        .Role_Name { font-size: 15px; font-weight: bold; }
        .MultiRoleGV tr td { border: 1px solid #ddd; padding: 6px 0; }
        #Studnt_Payments .form-control { display: inline; width: 96%; }
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <h3 class="mb-2">Pay order to Student</h3>

    <div id="Studnt_Payments">
        <asp:FormView ID="StudentBasicFormView" runat="server" DataSourceID="StudentBasucSQL" Width="100%">
            <ItemTemplate>
                <a target="_blank" href="Admission_Form.aspx?Student=<%# Eval("StudentID") %>&StudentClass=<%# Eval("StudentClassID") %>">Print Admission Form</a>
                <h4 class="m-0">
        ...
        <asp:SqlDataSource ID="StudentBasucSQL" runat="server" ConnectionString="<%$ ConnectionStrings:EducationConnectionString %>" SelectCommand="SELECT Student.ID, Student.StudentsName, CreateClass.Class, StudentsClass.RollNo, Student.StudentID, StudentsClass.StudentClassID FROM Student INNER JOIN StudentsClass ON Student.StudentID = StudentsClass.StudentID INNER JOIN CreateClass ON StudentsClass.ClassID = CreateClass.ClassID WHERE (StudentsClass.StudentID = @StudentID) AND (StudentsClass.SchoolID = @SchoolID)">
            <SelectParameters>
                                ...
                                <asp:GridView ID="Input_Multi_Role_GridView" runat="server" AutoGenerateColumns="False" CssClass="mGrid" Width="100%" DataSourceID="Multi_Role_SQL" DataKeyNames="AssignRoleID">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Pay For">
                                            <ItemTemplate>
                                                <asp:TextBox ID="Multi_PayForTextBox" autocomplete="off" placeholder="Pay For" Text='<%# Bind("PayFor") %>' runat="server" CssClass="form-control PayFor"></asp:TextBox>
                                        ...
                                        <asp:TemplateField HeaderText="Start Date">
                                            <ItemTemplate>
                                                <asp:TextBox ID="Multi_StartDateTextBox" placeholder="Start Date" Text='<%# Bind("StartDate","{0:d MMM yyyy}") %>' runat="server" CssClass="form-control Datetime Multi_Role" onkeypress="return isNumberKey(event)" autocomplete="off" onDrop="blur();return false;" onpaste="return false"></asp:TextBox>
                                        ...
                                        <asp:TemplateField HeaderText="End Date">
                                            <ItemTemplate>
                                                <asp:TextBox ID="Multi_EndDateTextBox" placeholder="End Date" Text='<%# Bind("EndDate","{0:d MMM yyyy}") %>' runat="server" CssClass="form-control Datetime Multi_Role" onkeypress="return isNumberKey(event)" autocomplete="off" onDrop="blur();return false;" onpaste="return false"></asp:TextBox>
...
FROM Income_Assign_Role as I_Role INNER JOIN Income_Roles ON I_Role.RoleID = Income_Roles.RoleID WHERE (I_Role.ClassID = @ClassID) AND (I_Role.EducationYearID = @EducationYearID) AND (I_Role.SchoolID = @SchoolID)) as Roles where No_Of_Role &lt;&gt; 1">
        ...
        <div class="table-responsive mb-4">
            ...
            <asp:GridView ID="One_Role_GridView" runat="server" AutoGenerateColumns="False" CssClass="mGrid" DataSourceID="Roles_1_SQL" DataKeyNames="RoleID">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Concession">
                        <ItemTemplate>
                            <asp:TextBox ID="One_DiscountTextBox" runat="server" CssClass="form-control" onkeypress="return isNumberKey(event)" autocomplete="off" onDrop="blur();return false;" onpaste="return false"></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
        ...
        <div class="table-responsive UAR2">
                            ...
                            <div class="criteriaData" style="display: none">
                                <asp:GridView ID="Input_Multi_Role_GridView" runat="server" AutoGenerateColumns="False" CssClass="mGrid" Width="100%">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Pay For">
                                            <ItemTemplate>
                                                <asp:TextBox ID="Multi_PayForTextBox" autocomplete="off" placeholder="Pay For" runat="server" CssClass="form-control PayFor"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="payForRF" Enabled="false" runat="server" ControlToValidate="Multi_PayForTextBox" CssClass="EroorStar" Display="Dynamic" ErrorMessage="!" SetFocusOnError="True" ValidationGroup="A"></asp:RequiredFieldValidator>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField>
        ...
        <div class="form-group">
            ...
            <asp:SqlDataSource ID="PayOrderSQL" runat="server" ConnectionString="<%$ ConnectionStrings:EducationConnectionString %>" InsertCommand="INSERT INTO Income_PayOrder(SchoolID, RegistrationID, StudentID, ClassID, StudentClassID, EducationYearID, Amount, PaidAmount, LateFee, Discount, LateFee_Discount, RoleID, PayFor, StartDate, EndDate, CreatedDate, AssignRoleID) VALUES (@SchoolID, @RegistrationID, @StudentID, @ClassID, @StudentClassID, @EducationYearID, @Amount, @PaidAmount, @LateFee, @Discount, @LateFee_Discount, @RoleID, @PayFor, @StartDate, @EndDate, GETDATE(), @AssignRoleID)" SelectCommand="SELECT * FROM [Income_PayOrder]">
                <InsertParameters>
                    <asp:SessionParameter Name="SchoolID" SessionField="SchoolID" />
                    ...
                    <asp:Parameter DefaultValue="" Name="AssignRoleID" />
                </InsertParameters>
            </asp:SqlDataSource>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        function DisableSubmit() { document.getElementById("<%=PayOrderButton.ClientID %>").disabled = true }
        window.onbeforeunload = DisableSubmit;

        function isNumberKey(a) { a = a.which ? a.which : event.keyCode; return 46 != a && 31 < a && (48 > a || 57 < a) ? !1 : !0 };


        //Off browser back button
