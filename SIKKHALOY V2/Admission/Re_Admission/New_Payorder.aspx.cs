...
{
    public partial class New_Payorder : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                if (string.IsNullOrEmpty(Request.QueryString["Student"]))
                    Response.Redirect("Assign_Class_And_Subjects.aspx");
            }
        }
            ...
            foreach (GridViewRow Role_Row in One_A_RoleGridView.Rows)
            {
                ...
                if (A_OR_CheckBox.Checked)
                {
                    ...
                    if (count < NumberOfPay)
                    {
                        ...
                        if (AmountTextBox.Text.Trim() != "" && double.TryParse(AmountTextBox.Text.Trim(), out Amount) && StartDateTextBox.Text.Trim() != "" && EndDateTextBox.Text.Trim() != "")
                        {
                    ...
                    foreach (GridViewRow In_Multi_Row in Input_Multi_Role_GridView.Rows)
                    {
                        ...
                        if (Input_MultiCheckBox.Checked)
                        {
                            ...
                            if (count < NumberOfPay)
                            {
                                ...
                                if (PayForTextBox.Text.Trim() != "" && AmountTextBox.Text.Trim() != "" && double.TryParse(AmountTextBox.Text.Trim(), out Amount) && StartDateTextBox.Text.Trim() != "" && EndDateTextBox.Text.Trim() != "")
                                {
                                    if (Amount >= DiscountAmount)
                                    {
                                        PayOrderSQL.InsertParameters["Amount"].DefaultValue = AmountTextBox.Text;
            ...
            foreach (GridViewRow One_Role_Row in One_Role_GridView.Rows)
            {
                ...
                if (One_Role_CheckBox.Checked)
                {
                    ...
                    if (count < NumberOfPay)
                    {
                        ...
                        if (One_PayForTextBox.Text.Trim() != "" && One_AmountTextBox.Text.Trim() != "" && double.TryParse(One_AmountTextBox.Text.Trim(), out Amount) && One_StartDateTextBox.Text.Trim() != "" && One_EndDateTextBox.Text.Trim() != "")
                        {
                            if (Amount >= DiscountAmount)
                            {
