<%@ Page Title="New Pay order" Language="C#" MasterPageFile="~/BASIC.Master" AutoEventWireup="true" CodeBehind="Payments.aspx.cs" Inherits="EDUCATION.COM.Admission.Promotion_Demotion.Payments" %>
                                ...
                                <asp:GridView ID="Input_Multi_Role_GridView" runat="server" AutoGenerateColumns="False" CssClass="mGrid" Width="100%" DataSourceID="Multi_Role_SQL" DataKeyNames="AssignRoleID">
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                <asp:TextBox ID="Multi_LateFeeTextBox" placeholder="Late Fee" Text='<%# Bind("LateFee") %>' runat="server" CssClass="form-control" onkeypress="return isNumberKey(event)" autocomplete="off" onDrop="blur();return false;" onpaste="return false"></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            <HeaderTemplate>
...
FROM Income_Assign_Role as I_Role INNER JOIN Income_Roles ON I_Role.RoleID = Income_Roles.RoleID WHERE (I_Role.ClassID = @ClassID) AND (I_Role.EducationYearID = @EducationYearID) AND (I_Role.SchoolID = @SchoolID)) as Roles where No_Of_Role &lt;&gt; 1">
        ...
        <div class="table-responsive mb-4">
            ...
            <asp:GridView ID="One_Role_GridView" runat="server" AutoGenerateColumns="False" CssClass="mGrid" DataSourceID="Roles_1_SQL" DataKeyNames="RoleID">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Pay For">
                        <ItemTemplate>
                            <asp:TextBox ID="One_PayForTextBox" runat="server" CssClass="form-control" placeholder="Pay For"></asp:TextBox>
                    ...
                    <asp:TemplateField HeaderText="Amount">
                        <ItemTemplate>
                            <asp:TextBox ID="One_AmountTextBox" placeholder="Amount" runat="server" CssClass="form-control" onkeypress="return isNumberKey(event)" autocomplete="off" onDrop="blur();return false;" onpaste="return false"></asp:TextBox>
                    ...
                    <asp:TemplateField HeaderText="Start Date">
                        <ItemTemplate>
                            <asp:TextBox ID="One_StartDateTextBox" placeholder="Start Date" runat="server" CssClass="form-control Datetime" onkeypress="return isNumberKey(event)" autocomplete="off" onDrop="blur();return false;" onpaste="return false"></asp:TextBox>
                    ...
                    <asp:TemplateField HeaderText="End Date">
                        <ItemTemplate>
                            <asp:TextBox ID="One_EndDateTextBox" placeholder="End Date" runat="server" CssClass="form-control Datetime" onkeypress="return isNumberKey(event)" autocomplete="off" onDrop="blur();return false;" onpaste="return false"></asp:TextBox>
        ...
        <asp:Button ID="PayOrderButton" runat="server" Text="Assign Payment" CssClass="btn btn-primary" OnClick="PayOrderButton_Click" ValidationGroup="A" />
