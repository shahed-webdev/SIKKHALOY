...
namespace EDUCATION.COM.Teacher
{
    public partial class Teacher_input : System.Web.UI.Page
    {
        ...
        {
            lockmsgId.Visible = false;
            Session["IGroup"] = GroupDropDownList.SelectedValue;
            Session["IShift"] = ShiftDropDownList.SelectedValue;
            Session["ISection"] = SectionDropDownList.SelectedValue;
        ...
        protected void GroupDropDownList_DataBound(object sender, EventArgs e)
        {
            ...
            if (IsPostBack)
                GroupDropDownList.Items.FindByValue(Session["IGroup"].ToString()).Selected = true;
        }
        ...
        protected void SectionDropDownList_DataBound(object sender, EventArgs e)
        {
           SectionDropDownList.Items.Insert(0, new ListItem("[ ALL SECTION ]", "%"));
            if (IsPostBack)
                SectionDropDownList.Items.FindByValue(Session["ISection"].ToString()).Selected = true;
        }
        ...
        protected void ShiftDropDownList_DataBound(object sender, EventArgs e)
        {
            ...
            if (IsPostBack)
                ShiftDropDownList.Items.FindByValue(Session["IShift"].ToString()).Selected = true;
        }
        ...
        protected void Input_Locked()
        {
            ...
            if(Input_Lock==true)
            {
                lockedMessage.Text = "Marks Submit Locked.";
             
                lockmsgId.Visible = true;
                
            }
            else { lockedMessage.Text = ""; }
        ...
        protected void StudentsNameCheckbox_CheckedChanged(object sender, EventArgs e)
        {
            if (StudentsNameCheckbox.Checked)
            {
                StudentsGridView.Columns[1].Visible = false;
            }
            else
            {
                StudentsGridView.Columns[1].Visible = true;
            }
