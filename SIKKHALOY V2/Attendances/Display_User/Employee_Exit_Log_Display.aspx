...
<body>
    <form id="form1" runat="server">
        <marquee behavior="scroll" direction="up" height="800" width="280" scrollamount="3">
...
WHERE (Employee_Attendance_Record.AttendanceDate = CONVERT(date, GETDATE())) AND (Employee_Attendance_Record.ExitConfirmed_Status = N'Yes') AND (Employee_Attendance_Record.SchoolID = @SchoolID)
