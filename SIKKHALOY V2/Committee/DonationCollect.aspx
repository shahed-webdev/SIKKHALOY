...
<div class="col-lg-8">
    <asp:FormView ID="MemberInfoFormView" runat="server" DataSourceID="MemberInfoSQL" RenderOuterTable="False">
        <EditItemTemplate>
            ...
            <br/>
            SmsNumber:
            <asp:TextBox ID="SmsNumberTextBox" runat="server" Text='<%# Bind("SmsNumber") %>'/>
            <br/>
            Address:
            ...
            <br/>
            TotalDonation:
            <asp:TextBox ID="TotalDonationTextBox" runat="server" Text='<%# Bind("TotalDonation") %>'/>
            <br/>
            PaidDonation:
            <asp:TextBox ID="PaidDonationTextBox" runat="server" Text='<%# Bind("PaidDonation") %>'/>
            <br/>
            CommitteeMemberType:
            <asp:TextBox ID="CommitteeMemberTypeTextBox" runat="server" Text='<%# Bind("CommitteeMemberType") %>'/>
            <br/>
        ...
        <ItemTemplate>
            ...
            <br/>
            SmsNumber:
            <asp:Label ID="SmsNumberLabel" runat="server" Text='<%# Bind("SmsNumber") %>'/>
            <br/>
            Address:
            ...
            <br/>
            TotalDonation:
            <asp:Label ID="TotalDonationLabel" runat="server" Text='<%# Bind("TotalDonation") %>'/>
            <br/>
            PaidDonation:
            <asp:Label ID="PaidDonationLabel" runat="server" Text='<%# Bind("PaidDonation") %>'/>
            <br/>
            CommitteeMemberType:
            <asp:Label ID="CommitteeMemberTypeLabel" runat="server" Text='<%# Bind("CommitteeMemberType") %>'/>
            <br/>
        </ItemTemplate>
    </asp:FormView>
    ...
    <asp:GridView ID="PaidRecordGridView" runat="server" AutoGenerateColumns="False" CssClass="mGrid" DataSourceID="PRecordSQL" AllowPaging="True" PageSize="3">
        <Columns>
            <asp:TemplateField HeaderText="Receipt">
                <ItemTemplate>
                    <asp:LinkButton ID="MSNLinkButton" runat="server" CommandArgument='<%# Eval("CommitteeMoneyReceiptId") %>' Text='<%# Eval("CommitteeMoneyReceiptSn") %>' ToolTip="Click To Details"/>
            ...
            <asp:TemplateField HeaderText="Paid">
                <ItemTemplate>
                    <%# Eval("TotalAmount") %> Tk
                    <small class="d-block">
                        <asp:LinkButton ID="Print_LinkButton" runat="server" CommandArgument='<%# Eval("CommitteeMoneyReceiptId") %>' ToolTip="Click To Print" OnCommand="Print_LinkButton_Command"><i class="fa fa-print"></i> Print</asp:LinkButton>
                    </small>
                </ItemTemplate>
