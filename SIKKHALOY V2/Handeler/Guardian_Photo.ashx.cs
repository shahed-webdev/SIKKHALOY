...
{
    /// <summary>
    /// Summary description for Guardian_Photo
    /// </summary>
    public class Guardian_Photo : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("SELECT Guardian_Photo from Student_Image where StudentImageID = @StudentImageID", con);
